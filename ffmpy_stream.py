...
def continuousStream(Flag):
	...
	while(Flag):
		...
		try:
			...
			t.join()
			print("ffmpeg has finished, through end of file or timeout, streaming shouldn't reach here")
			print("restarting now")

		except:
			print("Error, unable to maintain thread.  Connection to payload is interrupted.")	

if __name__ == "__main__":
	
	#make sure that this boolean is True otherwise the program will not run.
